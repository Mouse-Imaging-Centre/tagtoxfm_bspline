...
#ifndef DblArray
typedef blitz::Array<double,1> DblArray;
#endif
#ifndef FloatArray
typedef blitz::Array<float,1> FloatArray;
#endif
#ifndef IntArray
typedef blitz::Array<int,1> IntArray;
#endif
#ifndef DblMat
typedef blitz::Array<double,2> DblMat;
#endif
#ifndef FlMat
typedef blitz::Array<float,2> FlMat;
#endif
...
protected:
  ...
  DblMat   _knots;
  DblArray _zero;      // location of knot zero
...
protected:
  ...
  // these were formerly members of Spline class
  bool  _fitted;
  DblArray _coef;
  unsigned _nCoef;
  DblMat   _AtA, _Aj, _Ajt;
  DblMat   _J;
  DblArray _AtF;
  double   _lambda;
...
public:
  ...
  virtual bool clearDataPoints();
  virtual bool addDataPoint(const float *point, double value); 
  virtual bool fit();

  // evaluation functions
  operator bool() const { return _fitted; }
...
public:
  ...
  virtual void reset(void) { _index = 0; };
};
...
public:
  ...
  void reset(void) { _index = 0; _smallIndex = 0; };
};
...
public:
  ...
  virtual bool addDataPoint(int x, int y, int z, double value);
  virtual void saveState(char *filename) const;
  // evaluation functions
  operator bool() const { return _fitted; }
